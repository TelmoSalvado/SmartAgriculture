...
public class LoginActivity extends AppCompatActivity {
    ...
    private EditText campoEmail, campoPass;
    ...
    public void validarLogin(){
        ...
        autenticacao.signInWithEmailAndPassword(utilizador.getEmail(), utilizador.getPass()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    try {
                        ...
                        excecao = "utilizador nao está registado";
                    }catch (FirebaseAuthInvalidCredentialsException e){
                        excecao = "email e password não correspondem a nenhum utilizador registadfo";
                    }catch (Exception e){
